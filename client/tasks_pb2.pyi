...
class Task(_message.Message):
    __slots__ = ("id", "title", "description", "created_at", "data_limit", "status")
    ...
    data_limit: _timestamp_pb2.Timestamp
    status: Status
    def __init__(self, id: _Optional[int] = ..., title: _Optional[str] = ..., description: _Optional[str] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., data_limit: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., status: _Optional[_Union[Status, str]] = ...) -> None: ...
